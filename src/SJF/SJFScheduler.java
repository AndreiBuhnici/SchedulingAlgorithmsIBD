...
public class SJFScheduler {
    ...
    private static SJFBroker createBroker(String name) {
        try {
            return new SJFBroker(name);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    private static void printCloudletList(List<Cloudlet> list) {
        ...
        Log.println("Average delay using SJF: " + averageDelay);
        double throughput = calculateThroughput(list);
        Log.println("Throughput using SJF: " + throughput);
        double fairness = calculateFairness(list);
        Log.println("Fairness using SJF: " + fairness);
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            SJFBroker broker = createBroker("Broker_0");
