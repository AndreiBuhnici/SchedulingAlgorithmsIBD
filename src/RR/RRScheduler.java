...
public class RRScheduler {
    ...
    public static void main(String[] args) {
        Log.println("Starting RR RR.Scheduler...");
        ...
        try {
            ...
            Log.println(RRScheduler.class.getName() + " finished!");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static void printCloudletList(List<Cloudlet> list) {
        ...
        Log.println("Makespan using RR: " + makespan);
        double averageDelay = calculateAverageDelay(list);
        Log.println("Average delay using RR: " + averageDelay);
        double throughput = calculateThroughput(list);
        Log.println("Throughput using RR: " + throughput);
        double fairness = calculateFairness(list);
        Log.println("Fairness using RR: " + fairness);
    }
